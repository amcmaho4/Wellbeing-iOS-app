...
class homeTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
		...
		if reset {  // self.appDelegate.reset() {
		...
		var refreshControl = UIRefreshControl()
  		refreshControl.addTarget(self, action: Selector("maketheobjectswithLocalDataStore"), forControlEvents: UIControlEvents.ValueChanged)
...
//			if let timelasttaken = survey.surveyCompletedTime?.timeIntervalSinceNow{
//				if timelasttaken > -12*60*60 {
